...
- [x] **GRF-02**: User can view a whole-repo file/package graph with aggregated edges, laid out hierarchically with directory-structural grouping — never a force-directed whole-graph view
