...
Phase: 09 (release-please-and-goreleaser) — 7 of 8 resolved; 09-08 is the only plan left
Plan: 09-01..09-06 COMPLETE; 09-07 SKIPPED by maintainer decision (see 09-07-SUMMARY.md); 09-08 pending
...
Last activity: 2026-07-31 — Closed the perf blocker (no regression existed), protected main via ruleset + first PR (#3), hardened both release gates to blocking-human, and skipped 09-07's disposable proof with its reasoning recorded
