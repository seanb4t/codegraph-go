...
- [ ] 05-02-PLAN.md — Manifest `targets` requester set (schema 2) and the one manifest-owned skill-package writer: once-per-run shared write, last-requester removal, `kept (foreign)` ownership by manifest presence, hand-edit rewrite, exhaustive targets invariant, symlink-safe removal (AGENT-09, AGENT-13)
...
| 5. Agent Reach — Capability Model & Skill in Every Harness | 1/7 | In Progress|  |
