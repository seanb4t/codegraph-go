...
- [ ] 05-04-PLAN.md — D-13 exact-identity ownership table (8 × 2 × 2, `242ec0a` cited) RED-first, Cursor and opencode write the shared `.agents/skills/codegraph/` package through the table, SKILL.md frontmatter contract, Family (b) RED (AGENT-13, AGENT-04, AGENT-06, AGENT-09)
...
| 5. Agent Reach — Capability Model & Skill in Every Harness | 3/7 | In Progress|  |
