...
- [ ] 05-07-PLAN.md — D-11 verdict applied to Cursor's instructions target (no change unless pickup observed), install/uninstall help text, `docs/CLI-REFERENCE.md` regenerated through the drift gate, phase gate (AGENT-04, AGENT-08)
...
| 5. Agent Reach — Capability Model & Skill in Every Harness | 6/7 | In Progress|  |
