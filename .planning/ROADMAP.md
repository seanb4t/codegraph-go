...
- [ ] 05-03-PLAN.md — D-17: Claude's package shares one manifest with the shared dir when they are one physical directory (EvalSymlinks policy, RED-first symlinked-layout test), upgrade refresh gated on `claude ∈ targets` (AGENT-09, AGENT-13)
...
| 5. Agent Reach — Capability Model & Skill in Every Harness | 2/7 | In Progress|  |
