...
- [ ] CLI with parity commands: `init`, `install`, `uninstall`, `uninit`, `upgrade`, `explore`, plus migration (all but `migrate` shipped; `install`/`uninstall`/`upgrade` landed Phase 6, migration is Phase 7)
...
---
*Last updated: 2026-07-12 after Phase 6 (Agent Integrations & CLI Lifecycle) completion*
