...
//
// TestCorpusBehavior_CSharp is LANG-03's D-12 acceptance gate for C#.
//
...
// TestCorpusBehavior_CSharp validates, against a real (Claude's Discretion,
