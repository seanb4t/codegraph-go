...
func (f *traverseFakeReader) IterateExcludedFiles() (graphstore.ExcludedFileIterator, error) {
	return nil, errors.New("traverseFakeReader: IterateExcludedFiles not implemented")
}
