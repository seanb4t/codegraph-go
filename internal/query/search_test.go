...
func (f *searchFakeReader) IterateExcludedFiles() (graphstore.ExcludedFileIterator, error) {
	return nil, errors.New("searchFakeReader: IterateExcludedFiles not implemented")
}
