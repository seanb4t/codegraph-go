...
func (f *expandFakeReader) IterateExcludedFiles() (graphstore.ExcludedFileIterator, error) {
	return nil, errors.New("expandFakeReader: IterateExcludedFiles not implemented")
}
